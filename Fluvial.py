...
if os.path.exists(RasterFolder):
    ...
    arcpy.AddMessage("Raster folder location not found, please check and try again. "+str(RasterFolder))
    sys.exit()
...
for i in VelocityDirList:
    ...
    arcpy.CalculateField_management(i,"VERSION", "'"+Version+"'","PYTHON_9.3")
...
expression = "myBlock(!GRIDCODE!)"
codeblock = "def myBlock(x):\\n    if x =='1':\\n        return \"< 0.3m\"\\n    elif x =='2':\\n        return \"0.3m - 1.0m\"\\n    elif x=='3':\\n        return \">1.0m\"\\n    elif x=='999':\\n        return \"Data not Available\"\\n    else:\\n        return x"
...
for i in DepthReturnPeriods:
    ...
    arcpy.AddField_management(str(R4TEMPstr)+"\\"+str(FC),"VERSION", "TEXT", "", "", "","", "NULLABLE")
    arcpy.CalculateField_management(str(R4TEMPstr)+"\\"+str(FC),"VERSION", "'"+Version+"'","PYTHON_9.3")
...
VELOCITYDIRFinal= R4FINALstr+"\\"+VelocDirCombFC+".shp"
